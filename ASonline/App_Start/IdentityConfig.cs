...
namespace ASonline
{
    ...
    public class EmailService : IIdentityMessageService
    {
        ...
        void sendMail(IdentityMessage message)
        {
            ...
            msg.From = new MailAddress(ConfigurationManager.AppSettings["mailAccount"].ToString(),"AS Shop"); 
            ...
            credentials.UserName = ConfigurationManager.AppSettings["mailAccount"].ToString();
            credentials.Password = ConfigurationManager.AppSettings["mailPassword"].ToString();
